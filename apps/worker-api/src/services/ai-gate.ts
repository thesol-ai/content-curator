...
export function buildTranslationSystem(targets: TranslationTarget[], category: CategoryRow): string {
  ...
  return [
    ...
    '- Do not force emojis. If an emoji is used, it must be formal, sparse, and directly relevant to the story; avoid meme, hype, cheap, repeated, or decorative emojis.',
